...
<!--    <div class="center btmspace-80" >
    ...
    <div class="clear"></div>-->
<center>
    <form method="post" action="LeavesServlet">
    
    
    <h2>Apply Leave</h2>
   From <input type="date" name="date" value="" required style="border-radius: 22px; height: 42px; width:50%; font-weight: bold; text-align: center; "><br>
                 Number of Days <input type="text" name="days" value="" placeholder="Number of Days Here&hellip;" required style="border-radius: 22px; height: 42px; width:50%; font-weight: bold; text-align: center; "><br>
                 Reason 
                  <select name="reason"  style=" border-radius: 22px; height: 42px; width:50%; font-weight: bold; text-align: center; " >
                                                            <option name="unknown">Reason Here&hellip;</option>
    ...
    <button  type="submit" title="Submit" style="border-radius: 22px; height: 42px; width:50%; font-weight: bold; text-align: center; " ><em>Submit</em></button></center>
