...
<center>
    ...
    <h2>Update number of hours</h2>
                  ...
                  Account Number <input type="text" name="account" value="" placeholder="Account Here&hellip;" required style="border-radius: 22px; height: 42px; width:50%; font-weight: bold; text-align: center; "><br>
