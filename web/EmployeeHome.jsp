...
<!--    <div class="center btmspace-80" >
    ...
    <div class="clear"></div>-->
<center>
    <div style="height: 1000px; width: 100%" id="functionalities ">
        
            <div style="height: 500px; width: 98%; margin-bottom: 5px;">                
                <div style="height: 50px; width: 48%; float: left; margin-bottom: 20px;">
                    <a href="leaves.jsp" class="b-link-stripe b-animate-go   swipebox"  title="">
                    <img src="images/leave.jpg" style="height: 100%; width: 100%; border-radius: 5px;">
                    <div class="b-wrapper">
                ...
                <div style="height: 50px; width: 48%; float: right; margin-bottom: 20px;">
                    <a href="Tasks.jsp" class="b-link-stripe b-animate-go   swipebox"  title="">
                    <img src="images/tasks.png" style="height: 100%; width: 100%; border-radius: 5px; ">
                    <div class="b-wrapper">
							<h2 class="b-animate b-from-left    b-delay03 ">
								<div class="text-info">
									<h4>View Tasks</h4>
        ...
        <div style="height: 500px; width: 98%; margin-bottom: 20px;">                
                <div style="height: 80px; width: 48%; float: left;margin-bottom: 20px;">
                    <a href="Problem.jsp" class="b-link-stripe b-animate-go   swipebox"  title="">
                        <img src="images/problem.jpg" style="height: 100%; width: 100%; border-radius: 5px;">
                    <div class="b-wrapper">
							<h2 class="b-animate b-from-left    b-delay03 ">
								<div class="text-info">
                ...
                <div style="height: 80px; width: 48%; float: right;margin-bottom: 20px;">
                    <a href="Salary.jsp" class="b-link-stripe b-animate-go   swipebox"  title="">
                        <img src="images/Salary.jpeg" style="height: 100%; width: 100%; border-radius: 5px; margin-bottom: 50px;">
                    <div class="b-wrapper">
							<h2 class="b-animate b-from-left    b-delay03 ">
								<div class="text-info">
									<h4>View Salary</h4>
                ...
                <div style="height: auto; width: 48%; float: right; margin-bottom: 20px;">
