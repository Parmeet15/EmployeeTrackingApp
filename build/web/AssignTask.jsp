		...
		<div class="container">
			...
			<div class="contact-info">
				<ul>
						...
						<div class="position">
							<a href="#" ></a>
                                                        <select name="empid" class="text" style="border-radius: 22px; height: 42px; width:50%; font-weight: bold; text-align: center; ">
...
<option value="<%=rs.getString(1)%>"><%=rs.getString(1)%></option>                 
    ...
    out.println(e);
             ...
             %>           
					...
					<li class="second">
						<div class="position">
                                                    <a href="#" class=" icon msg"></a><textarea  placeholder="Task"name="task" style="border-radius: 22px; height: 42px; width:50%; font-weight: bold; text-align: center; "></textarea>
							<div class="clear"></div>
							<div class="dot1">
								<span> </span>
							</div>
				...
				<input type="submit" onclick="myFunction()" value="ASSIGN" style="border-radius: 22px; height: 42px; width:50%; font-weight: bold; text-align: center; ">
                                </form>
                                                       <h2><%String st=(String)request.getAttribute("status");
                                                       if(st!=null)
                                                       {
                                                       out.println(st);
                                                       }
