...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="center btmspace-80">
        <h1 class="heading">Pay with Paypal</h1>
    </div>
    <center>
          <div class="container">
         ...
         <%
                Properties cdata=(Properties) session.getAttribute("clientdata");
                 String period=(String)   cdata.get("mperiod");
             String cost=null;
             if(period.equals("1"))
             {
                 cost="100";
             ...
             <form action="https://www.sandbox.paypal.com/cgi-bin/webscr">
                 <input type="hidden" name="cmd" value="_xclick"/>
                  <input type="hidden" name="business" value="navukpseller@gmail.com"/>
              
                   <input type="hidden" name="item_name" value="GPS Tracking Service"/>
                    <input type="hidden" name="amount" value="<%=cost %>"/>
                
                <input type="hidden" name="cancel_return" value="http://localhost:8080/ETS2k17jdbc/register.jsp"/>
               <input type="hidden" name="return" value="http://localhost:8080/ETS2k17/paymentSuccess.jsp"/>
             <input type="image" src="images/paypal.jpg"/>
            </form>
         
                    <h1><a href="paymentSuccess.jsp">Skip</a></h1> 
          </div>
