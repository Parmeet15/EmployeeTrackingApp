...
<center>
    ...
    <form method="post" action="ProblemServlet">
    ...
    <h2>Raise a Ticket</h2>
                 ...
                 Issue Type 
                  <select name="type"  style=" border-radius: 22px; height: 42px; width:50%; font-weight: bold; text-align: center; " >
                                                            <option name="unknown">Type Here&hellip;</option>
                                                            <option name="hw">Hardware</option>
                                                            <option name="sw">Software</option>
                                                            <option name="en">Environemnt</option>
                                                            <option name="te">Team</option>
                  </select><br>
             Issue <textarea name="issue" cols="50" rows="10"></textarea>
    <input type="hidden" name="email" value="<%=session.getAttribute("email")%>"/>
    <input type="hidden" name="lid" value="<%=session.getAttribute("lid")%>"/>
    
    <button  type="submit" title="Submit" style="border-radius: 22px; height: 42px; width:50%; font-weight: bold; text-align: center; " ><em>Submit</em></button>
