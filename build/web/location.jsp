...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="center btmspace-80">
        <h1 class="heading">Add Location of Company</h1>
    ...
    <center>
           <form  action="LocationServlet" method="post">
                <fieldset>
                  ...
                  <input type="text" name="loc" value="" placeholder="Location Here&hellip;" required style="border-radius: 22px; height: 42px; width:50%; font-weight: bold; text-align: center; "><br>
